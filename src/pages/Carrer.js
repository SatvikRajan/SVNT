...
export const CareersPage = () => {
  ...
  const svg = <svg style={{marginLeft: '50px', marginRight: '25px'}} width="30" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="recruitment" className="recruitment">
          ...
          <div className="jobs">
            ...
            {showForm ? (
              ...
              <a className='apply' onClick={handleApplyClick} href="">Apply Now</a>
              </div>
