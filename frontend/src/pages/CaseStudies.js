...
import itc3 from "../images/CaseStudies/itc3.webp";
import itc4 from "../images/CaseStudies/itc4.webp";
import jsw1 from '../images/CaseStudies/jsw1.webp';
import jsw2 from '../images/CaseStudies/jsw2.webp';
import jsw3 from '../images/CaseStudies/jsw3.webp';
import jsw4 from '../images/CaseStudies/jsw4.webp';
import kia1 from '../images/CaseStudies/kia1.webp';
import kia2 from '../images/CaseStudies/kia2.webp';
import kia3 from '../images/CaseStudies/kia3.webp';
import oem1 from '../images/CaseStudies/oem1.webp';
import oem2 from '../images/CaseStudies/oem2.webp';
...
const cs = [
  ['itc', 'ITC Hotels Limited',
    ...
    [[`ITC is one of India's top private companies and is a clear market leader in Indian Fast Moving Consumer Goods, Hotels, Paperboards and Packaging, Agri Business and Information Technology. Its pre-eminent hotel chain in India is a trailblazer in 'Responsible Luxury'`], [`With over 130 hotels in 80 locations, ITC is committed to creating lasting value for the nation and its stakeholders. ITC Hotels offer unique, luxurious experiences that are environmentally friendly. With a strong dedication to guests and the planet, ITC sets a high standard for sustainability and corporate responsibility.`
    ], [

      `But how does the world's largest hotel chain manage to keep all their hotels secure and well-monitored? Managing a large hotel involves creating advanced security and communication systems. ITC Royal Bengal teamed up with SVNT to accomplish this ambitious goal.`]], `Relying on expert support`,
    ...
    [`Internally hotel staff stay connected through a specialised network that operates on a ring topology, where devices are connected in a circular path. This setup not only keeps information flowing even if a part of the network goes down but also speeds up how quickly messages get through.`]
      , [`A key role in boosting security  is the access control network, which includes door controllers, master controllers, and CCTV cameras to manage who can enter different areas. For example, the door controller handles locking and unlocking doors based on authorised personnel, enhancing security in rooms and buildings. Behind  the scenes, a central control unit acts as the main hub, overseeing and coordinating multiple devices to keep things running smoothly throughout the hotel. Network access control (NAC) solutions keep an eye on who gets access to the hotel's network and makes sure that both  guests and staff are safe and secure.`]], `Keeping Things Running Smoothly`,
    [
  ...
  ], oem1, oem2, ``, [[`Om Books International is one of the largest book publishing platforms with a huge collection of books from top selling authors. With 1,500 books already published and many more on the way, Om Books International has versions of its titles in over 28 languages.
`],
  ...
  [`To ensure comprehensive security for Good Shepherd Church and Pratigya Hostel in Hyderabad, we embarked on an ambitious project. Our goal was to cover every corner, from indoor halls to semi-outdoor areas, with a state-of-the-art cloud-based surveillance system. `]],
    `A Silver Lining`, [[`Genetec's Stratocast makes setting up a network video security system a breeze. Since it is cloud-based, accessing and managing surveillance footage is super easy—you can do it from anywhere using your laptop, tablet, or smartphone. This setup means security teams can quickly respond to any issues and resolve incidents faster, ensuring everything runs smoothly and safely. So, Stratocast not only simplifies but also enhances efficiency in handling security footage and incidents.`], [`Utilising IP cameras, the system records video continuously, storing the footage securely in the cloud. The setup can expand effortlessly without requiring major changes. Security staff can watch live feeds from any device, ensuring constant oversight.`]
...
`,],
  ...
  , ['cfcl', 'Chambal Fertilizers Limited ', [
    ...
    [["Chambal Fertilisers and Chemicals Limited (CFCL), founded in 1985 by Zuari Industries Limited, has become a major player in India's private sector fertiliser industry. Situated in the Gadepan area of Rajasthan's Kota district, CFCL operates two cutting-edge nitrogenous fertiliser plants. Together, these plants produce around 2 million metric tons of urea each year. Over the years, CFCL has not only bolstered its presence in the fertiliser market but has also emerged as a leader in North India's pesticide business."]],
    `Cameras That Think`,
